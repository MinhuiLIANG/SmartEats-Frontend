...
import endinfosm from '../Getapi/getendsm'
import { questionnaire } from '../fixedans/fixsm'
...
export default function EndPage({ navigation }) {
  ...
  useEffect(() => {
    if (acca != '' && expa != '' && expb != '' && expc != '' && intera != '' && usefa != '' && usefb != '' && trusta != '' && trustb != '' && eata != '' && useia != '' && useib != '' && useic != '' && quaa != '' && ada != '' && adb != '' && time != '' && edul != '' && workf != '' && race != '' && feedback != '' && extra != '') 
    {
  ...
  }, [acca, expa, expb, expc, intera, usefa, usefb, trusta, trustb, eata, useia, useib, useic, quaa, ada, adb, time, edul, workf, race, feedback, edut, extra]);
          ...
          onPress={async() => {
            if (acca != '' && expa != '' && expb != '' && expc != '' && intera != '' && usefa != '' && usefb != '' && trusta != '' && trustb != '' && eata != '' && useia != '' && useib != '' && useic != '' && quaa != '' && ada != '' && adb != '' && time != '' && edul != '' && workf != '' && race != '' && feedback != '' && extra != '')
            {
              ...
              else
              {
                ...
                {
                  setDis(true);
                  let status = await endinfosm(userId, acca, expa, expb, expc, intera, usefa, usefb, trusta, trustb, eata, useia, useib, useic, quaa, ada, adb, time, edul + '(' + edut + ')', workf, race, feedback, extra);
